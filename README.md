...
```
To ensure only verified users can access certain pages. 
```

2. What is the point of a [JSON Web Token](https://jwt.io/introduction)? Why would we want to use it?

```
JWT is used to secure users information. We'd want to use it in order to keep sensitive info, such as a password, inaccessible to others.
```

3. Why would we hash a user's password when they sign up? What's the point?

```
Therefore the real password can be kept secret.
```
